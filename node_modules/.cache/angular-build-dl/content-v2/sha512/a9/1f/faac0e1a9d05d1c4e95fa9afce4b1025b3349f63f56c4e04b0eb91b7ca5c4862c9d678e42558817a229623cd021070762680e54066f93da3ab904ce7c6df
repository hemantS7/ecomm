...
let AddProductComponent = class AddProductComponent {
    constructor(appService, formBuilder, activatedRoute) {
...
AddProductComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./add-product.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/products/add-product/add-product.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./add-product.component.scss */ "./src/app/admin/products/add-product/add-product.component.scss")).default]
    }),
    __metadata("design:paramtypes", [src_app_app_service__WEBPACK_IMPORTED_MODULE_2__["AppService"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
], AddProductComponent);
...
/* harmony import */ var _category_dialog_category_dialog_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./category-dialog/category-dialog.component */ "./src/app/admin/products/categories/category-dialog/category-dialog.component.ts");
...
let CategoriesComponent = class CategoriesComponent {
    ...
    openCategoryDialog(data) {
        const dialogRef = this.dialog.open(_category_dialog_category_dialog_component__WEBPACK_IMPORTED_MODULE_2__["CategoryDialogComponent"], {
            data: {
                category: data,
    ...
    remove(category) {
        const dialogRef = this.dialog.open(src_app_shared_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmDialogComponent"], {
            maxWidth: "400px",
            data: {
...
CategoriesComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./categories.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/products/categories/categories.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./categories.component.scss */ "./src/app/admin/products/categories/categories.component.scss")).default]
    }),
    __metadata("design:paramtypes", [src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"], src_app_app_settings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"]])
], CategoriesComponent);
...
let CategoryDialogComponent = class CategoryDialogComponent {
...
CategoryDialogComponent.ctorParameters = () => [
...
CategoryDialogComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./category-dialog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/products/categories/category-dialog/category-dialog.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./category-dialog.component.scss */ "./src/app/admin/products/categories/category-dialog/category-dialog.component.scss")).default]
    }),
...
/* harmony import */ var _product_zoom_product_zoom_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./product-zoom/product-zoom.component */ "./src/app/admin/products/product-detail/product-zoom/product-zoom.component.ts");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/dialog.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var src_app_theme_utils_app_validators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/theme/utils/app-validators */ "./src/app/theme/utils/app-validators.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ProductDetailComponent.propDecorators = {
    zoomViewer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['zoomViewer',] }],
    directiveRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: [ngx_swiper_wrapper__WEBPACK_IMPORTED_MODULE_3__["SwiperDirective"],] }]
};
ProductDetailComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-product-detail',
        template: __importDefault(__webpack_require__(/*! raw-loader!./product-detail.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/products/product-detail/product-detail.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./product-detail.component.scss */ "./src/app/admin/products/product-detail/product-detail.component.scss")).default]
    }),
    __metadata("design:paramtypes", [src_app_app_service__WEBPACK_IMPORTED_MODULE_2__["AppService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialog"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"]])
...
ProductZoomComponent.propDecorators = {
    zoomImage: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['zoomImage', { static: true },] }]
};
ProductZoomComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-product-zoom',
        template: __importDefault(__webpack_require__(/*! raw-loader!./product-zoom.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/products/product-detail/product-zoom/product-zoom.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None,
        styles: [__importDefault(__webpack_require__(/*! ./product-zoom.component.scss */ "./src/app/admin/products/product-detail/product-zoom/product-zoom.component.scss")).default]
    }),
...
ProductListComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./product-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/products/product-list/product-list.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./product-list.component.scss */ "./src/app/admin/products/product-list/product-list.component.scss")).default]
    }),
    __metadata("design:paramtypes", [src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"]])
...
/* harmony import */ var ngx_input_file__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-input-file */ "./node_modules/ngx-input-file/__ivy_ngcc__/fesm2015/ngx-input-file.js");
/* harmony import */ var _product_list_product_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./product-list/product-list.component */ "./src/app/admin/products/product-list/product-list.component.ts");
/* harmony import */ var _product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./product-detail/product-detail.component */ "./src/app/admin/products/product-detail/product-detail.component.ts");
/* harmony import */ var _product_detail_product_zoom_product_zoom_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./product-detail/product-zoom/product-zoom.component */ "./src/app/admin/products/product-detail/product-zoom/product-zoom.component.ts");
/* harmony import */ var _add_product_add_product_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./add-product/add-product.component */ "./src/app/admin/products/add-product/add-product.component.ts");
/* harmony import */ var _categories_categories_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./categories/categories.component */ "./src/app/admin/products/categories/categories.component.ts");
/* harmony import */ var _categories_category_dialog_category_dialog_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./categories/category-dialog/category-dialog.component */ "./src/app/admin/products/categories/category-dialog/category-dialog.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
