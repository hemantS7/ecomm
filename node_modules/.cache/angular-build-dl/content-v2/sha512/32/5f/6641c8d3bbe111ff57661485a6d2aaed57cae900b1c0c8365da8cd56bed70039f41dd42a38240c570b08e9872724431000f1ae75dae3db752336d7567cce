...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-brands-brands-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesBrandsBrandBrandComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesBrandsBrandsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesBrandsBrandBrandComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesBrandsBrandBrandComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var BrandComponent = /*#__PURE__*/function () {
      function BrandComponent(appSettings, activatedRoute, appService, dialog, router) {
      ...
      _createClass(BrandComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this.activatedRoute.params.subscribe(function (params) {// console.log(params['name']);
          });
        ...
        value: function getAllProducts() {
          ...
          this.appService.getProducts("brand").subscribe(function (data) {
            _this.products = data; //for show more product  
        ...
        value: function openProductDialog(product) {
          ...
          dialogRef.afterClosed().subscribe(function (product) {
            if (product) {
              _this3.router.navigate(['/products', product.id, product.name]);
            }
          });
        }
      }, {
    ...
    BrandComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/brands/brand/brand.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./brand.component.scss */
      "./src/app/pages/brands/brand/brand.component.scss"))["default"]]
  ...
  /***/
  function srcAppPagesBrandsBrandsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesBrandsBrandsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var BrandsComponent = /*#__PURE__*/function () {
      ...
      _createClass(BrandsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.brands = this.appService.getBrands(); // this.brands.sort((a, b)=>{
    ...
    BrandsComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      selector: 'app-brands',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./brands.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/brands/brands.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./brands.component.scss */
      "./src/app/pages/brands/brands.component.scss"))["default"]]
    }), __metadata("design:paramtypes", [_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"]])], BrandsComponent);
    /***/
  },
  ...
  function srcAppPagesBrandsBrandsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _theme_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../theme/pipes/pipes.module */
    "./src/app/theme/pipes/pipes.module.ts");
    /* harmony import */


    var _brands_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./brands.component */
    "./src/app/pages/brands/brands.component.ts");
    /* harmony import */
    ...
    var routes = [{
      path: '',
      component: _brands_component__WEBPACK_IMPORTED_MODULE_7__["BrandsComponent"],
      pathMatch: 'full'
    }, {
      path: ':name',
      component: _brand_brand_component__WEBPACK_IMPORTED_MODULE_8__["BrandComponent"]
    }];
    ...
    BrandsModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_4__["NgxPaginationModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _theme_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_6__["PipesModule"]],
      declarations: [_brands_component__WEBPACK_IMPORTED_MODULE_7__["BrandsComponent"], _brand_brand_component__WEBPACK_IMPORTED_MODULE_8__["BrandComponent"]]
    })], BrandsModule);
    /***/
  }
}]);
