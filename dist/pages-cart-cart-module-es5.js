...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-cart-cart-module"], {
  ...
  function srcAppPagesCartCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartComponent = /*#__PURE__*/function () {
      ...
      _createClass(CartComponent, [{
        ...
        key: "updateCart",
        value: function updateCart(value) {
          var _this2 = this;
          ...
          if (value) {
            ...
            this.total.forEach(function (price) {
              _this2.grandTotal += price;
            });
            this.cartItemCountTotal = 0;
            this.cartItemCount.forEach(function (count) {
              _this2.cartItemCountTotal += count;
            });
            this.appService.Data.totalPrice = this.grandTotal;
            this.appService.Data.totalCartCount = this.cartItemCountTotal;
            this.appService.Data.cartList.forEach(function (product) {
              _this2.cartItemCount.forEach(function (count, index) {
                if (product.id == index) {
        ...
        value: function remove(product) {
          ...
          if (index !== -1) {
            ...
            this.total.forEach(function (val) {
              if (val == _this3.total[product.id]) {
                _this3.total[product.id] = 0;
              }
            });
            this.cartItemCountTotal = this.cartItemCountTotal - this.cartItemCount[product.id];
            this.appService.Data.totalCartCount = this.cartItemCountTotal;
            this.cartItemCount.forEach(function (val) {
              if (val == _this3.cartItemCount[product.id]) {
                _this3.cartItemCount[product.id] = 0;
              }
            });
        ...
        value: function clear() {
          ...
          this.appService.Data.cartList.forEach(function (product) {
            _this4.appService.resetProductCartCount(product);
          });
    ...
    }), __metadata("design:paramtypes", [_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"]])], CartComponent);
    /***/
  },
  ...
  function srcAppPagesCartCartModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      path: '',
      component: _cart_component__WEBPACK_IMPORTED_MODULE_4__["CartComponent"],
      pathMatch: 'full'
    }];
    ...
    CartModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
