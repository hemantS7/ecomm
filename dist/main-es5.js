...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModelsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Product = function Product(id, ITEM_ID, name, images, oldPrice, newPrice, discount, ratingsCount, ratingsValue, description, availibilityCount, cartCount, color, size, weight, categoryId) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      }), _shared_shared_module__WEBPACK_IMPORTED_MODULE_10__["SharedModule"], _app_routing__WEBPACK_IMPORTED_MODULE_11__["AppRoutingModule"]],
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~coupons-coupons-module~customers-customers-module~followers-followers-module~pages-brands-br~34a2f995"), __webpack_require__.e("pages-brands-brands-module")]).then(__webpack_require__.bind(null,
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~coupons-coupons-module~customers-customers-module~followers-followers-module~pages-brands-br~34a2f995"), __webpack_require__.e("common"), __webpack_require__.e("pages-products-products-module")]).then(__webpack_require__.bind(null,
    ...
    var AppService = /*#__PURE__*/function () {
      ...
      _createClass(AppService, [{
        ...
        value: function addToCart(product) {
          ...
          if (this.Data.cartList.filter(function (x) {
            return x.ITEM_ID == product.ITEM_ID;
          })[0]) {
  ...
  /***/
  "./src/app/common/restapi.ts":
  /*!***********************************!*\
    !*** ./src/app/common/restapi.ts ***!
    \***********************************/

  /*! exports provided: API, ENVIRONMENT */

  /***/
  function srcAppCommonRestapiTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/http-interceptors/auth.service.ts":
  /*!***************************************************!*\
    !*** ./src/app/http-interceptors/auth.service.ts ***!
    \***************************************************/
  ...
  /***/
  function srcAppHttpInterceptorsAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _common_restapi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../common/restapi */
    "./src/app/common/restapi.ts");
    ...
    var AuthService = /*#__PURE__*/function () {
      function AuthService(http, _router) {
        ...
        this.currentUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](localStorage.getItem("currentUser"));
        this.currentUser = this.currentUserSubject.asObservable();
        this.deviceInfo = null;
        this.currentUserData = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        this.logoutDone = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](false); // Local IP Integration Start
      ...
      _createClass(AuthService, [{
        ...
        value: function login(form) {
          ...
          var payload = {
            ...
            Ip: this.localIp ? this.localIp : '0.0.0.0',
            browserName: this.deviceInfo.browser,
            loginSession: "login"
          };
          console.log("Payload for Login :: ", payload);
          return this.http.post("".concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["ENVIRONMENT"].BASEURL).concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["API"].LOGIN), payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (user) {
            ...
            if (user.hasOwnProperty('accessToken') && user.accessToken != undefined) {
              ...
              user['inActive'] = 'N';
              localStorage.setItem('currentUser', window.btoa(window.btoa(window.btoa(window.btoa(JSON.stringify(user))))));
              localStorage.setItem('accessToken', user['accessToken']); // let data = this._encdec.set(ENVIRONMENT.ENDDESCKEY, user);
        ...
        value: function logout() {
          ...
          return this.http.post("".concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["ENVIRONMENT"].BASEURL).concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["API"].LOGOUT), logoutPayload, {
        ...
        value: function getCurrentUser() {
          if (localStorage.getItem("currentUser")) {
            return this.currentUser = JSON.parse(window.atob(window.atob(window.atob(window.atob(localStorage.getItem("currentUser"))))));
          }
        }
      }, {
        key: "setHeader",
        value: function setHeader() {
          // if (localStorage.getItem("currentUser")) {
          return this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set("Company-Code", "demotest") //changes made on 13-11
        ...
        value: function changeAgentStatus(data) {
          var accessToken = localStorage.getItem('accessToken');
          var payload = {
            userId: data
          };
          return this.http.post("".concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["ENVIRONMENT"].BASEURL).concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["API"].USERACTIVITY), payload, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set("Content-Type", "application/json").set("authorization", accessToken)
        ...
        value: function getAgentUser() {
          var dd = localStorage.getItem("agentUser");
        ...
        key: "getCurrentUserEnc",
        value: function getCurrentUserEnc(data) {
          var dd = data;
    ...
    AuthService = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
      providedIn: "root"
    }), __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], AuthService);
    /***/
  },
  ...
  function srcAppPagesPagesComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".main {\n  min-height: 400px;\n  min-height: calc(100vh - 288px);\n  padding: 16px;\n}\n\n.sidenav {\n  width: 250px;\n  padding: 8px 16px;\n  position: fixed;\n}\n\n.sidenav .close {\n  margin-left: 178px;\n}\n\n.sidenav .divider {\n  margin: 8px 0;\n}\n\n.cart-items-count {\n  position: absolute;\n  top: -3px;\n  left: 26px;\n  background: #f44336;\n  height: 18px;\n  width: 18px;\n  line-height: 18px;\n  border-radius: 50%;\n  font-size: 11px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesPagesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_product_categories_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../services/product-categories.service */
    ...
    var PagesComponent = /*#__PURE__*/function () {
      function PagesComponent(appSettings, appService, sidenavMenuService, router, _productCategoriesService) {
        ...
        this.router = router;
        this._productCategoriesService = _productCategoriesService;
      ...
      _createClass(PagesComponent, [{
        ...
        value: function ngOnInit() {
          alert('hhhhh');
          this.getCategories();
          this.sidenavMenuItems = this.sidenavMenuService.getSidenavMenuItems(); // this.getCategory();
        }
      }, {
        key: "getCategories",
        value: function getCategories() {
          ...
          this.appService.getCategories().subscribe(function (data) {
            ...
            _this4.category = data[0];
            _this4.appService.Data.categories = data;
          });
        }
      }, {
        key: "changeCategory",
        ...
        value: function clear() {
          ...
          this.appService.Data.cartList.forEach(function (product) {
            _this5.appService.resetProductCartCount(product);
          });
    ...
    PagesComponent.ctorParameters = function () {
      return [{
        ...
        type: _services_product_categories_service__WEBPACK_IMPORTED_MODULE_5__["ProductCategoriesService"]
      }];
    };
  ...
  /***/
  function srcAppServicesProductCategoriesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductCategoriesService", function () {
    ...
    var _http_interceptors_auth_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var ProductCategoriesService = /*#__PURE__*/function () {
      function ProductCategoriesService(http, router, authService) {
        _classCallCheck(this, ProductCategoriesService);

        this.http = http;
        this.router = router;
        this.authService = authService;
        this.baseUrl = _common_restapi__WEBPACK_IMPORTED_MODULE_5__["ENVIRONMENT"].BASEURL;
        this.gettingData = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.gettingupdatedphrases = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.phraseAllData = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.currentUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]("123");
        this.currentUser = this.currentUserSubject.asObservable();
        this.headers = this.authService.setHeader(); // console.log(this.headers)
      }

      _createClass(ProductCategoriesService, [{
        key: "updateProfileData",
        value: function updateProfileData(user) {
          this.currentUserSubject.next(user);
        } //this method is used for create intent list

      }, {
        key: "GetClients",
        value: function GetClients(data) {
          var accessToken = localStorage.getItem('accessToken');
          return this.http.post(this.baseUrl + "".concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["API"].GET_CLIENTS), data, {
            headers: this.headers
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
            return res;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.authService.handleError));
        }
      }, {
        key: "DeleteClient",
        value: function DeleteClient(data) {
          var accessToken = localStorage.getItem('accessToken');
          return this.http.post(this.baseUrl + "".concat(_common_restapi__WEBPACK_IMPORTED_MODULE_5__["API"].DELETE_CLIENT), data, {
            headers: this.headers
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
            return res;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.authService.handleError));
        ...
        value: function getCategoryDetails() {
          var payload = '{"entityRows":[{"PA_ID":11189,"LOGIN_PA_ID":11189}]}'; // console.log("this header is on reports service ", payload);
    ...
    ProductCategoriesService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]
      }, {
        type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]
      }, {
        type: _http_interceptors_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]
      }];
    };

    ProductCategoriesService = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
      providedIn: 'root'
    }), __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _http_interceptors_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]])], ProductCategoriesService);
    /***/
  },
    ...
    var CategoryListComponent = /*#__PURE__*/function () {
      ...
      _createClass(CategoryListComponent, [{
        ...
        value: function ngDoCheck() {
          this.mainCategories = this.categories; // if(this.categories && !this.mainCategories) {
    ...
    var ControlsComponent = /*#__PURE__*/function () {
      ...
      _createClass(ControlsComponent, [{
        ...
        value: function addToCart(product) {
          ...
          var currentProduct = this.appService.Data.cartList.filter(function (x) {
            return x.ITEM_ID == product.ITEM_ID;
          })[0];
  ...
  function srcAppSharedMainCarouselMainCarouselComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".main-slider {\n  height: 270px;\n  margin-top: 14px;\n}\n.main-slider .slide-item {\n  height: 100%;\n  background-size: cover;\n  background-position: center;\n}\n.main-slider .slide-item .content {\n  height: 100%;\n  position: relative;\n  z-index: 9;\n}\n.main-slider .slide-item .content h1 {\n  font-size: 48px;\n  text-align: center;\n  color: #fff;\n  text-transform: uppercase;\n  letter-spacing: 3px;\n}\n.main-slider .slide-item .content h3 {\n  font-size: 36px;\n  text-align: center;\n  color: #fff;\n  margin-bottom: 30px;\n  font-weight: 300;\n  letter-spacing: 2px;\n}\n.main-slider .slide-item .mask {\n  opacity: 0.6;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  overflow: hidden;\n  z-index: 0;\n  background-color: rgba(0, 0, 0, 0.8);\n}\n.main-slider .swiper-lazy-preloader {\n  top: 18%;\n}\n@media (max-width: 575px) {\n  .main-slider {\n    height: 280px;\n  }\n  .main-slider .slide-item .content h1 {\n    font-size: 24px;\n    letter-spacing: 3px;\n  }\n  .main-slider .slide-item .content h3 {\n    font-size: 18px;\n    margin-bottom: 10px;\n    letter-spacing: 2px;\n  }\n}\n@media (min-width: 576px) and (max-width: 767px) {\n  .main-slider {\n    height: 320px;\n  }\n  .main-slider .slide-item .content h1 {\n    font-size: 36px;\n    letter-spacing: 3px;\n  }\n  .main-slider .slide-item .content h3 {\n    font-size: 24px;\n    margin-bottom: 20px;\n    letter-spacing: 2px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppSharedProductsCarouselProductsCarouselComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".swiper-container {\n  padding: 16px 2px 2px 2px;\n}\n.swiper-container .swiper-slide {\n  text-align: center;\n}\n.swiper-button-next.swiper-button-disabled,\n.swiper-button-prev.swiper-button-disabled {\n  pointer-events: auto;\n}\n.outline-btn {\n  background-color: #f4433600 !important;\n  border: 1px solid #f44336 !important;\n  color: #f44336 !important;\n}\n.product-item .prices .new-price {\n  font-size: 20px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppSharedProductsCarouselProductsCarouselComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductsCarouselComponent = /*#__PURE__*/function () {
      function ProductsCarouselComponent(appSettings, appService, dialog, router, snackBar) {
      ...
      _createClass(ProductsCarouselComponent, [{
        ...
        //     this.count++;
        //     let obj = {
        //       productId: this.product.ITEM_ID,
        //       soldQuantity: this.count,
        //       total: this.count * this.product.newPrice
        //     }
        //     this.changeQuantity(obj);
        ...
        value: function addToCart(product) {
          ...
          if (currentProduct) {//  if((currentProduct.cartCount + this.count) <= this.product.count){
            //    product.cartCount = currentProduct.cartCount + this.count;
            //  }
            //  else{
    ...
    }), __metadata("design:paramtypes", [src_app_app_settings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"], _app_service__WEBPACK_IMPORTED_MODULE_4__["AppService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_6__["MatSnackBar"]])], ProductsCarouselComponent);
    /***/
  },
      ...
      function BreadcrumbComponent(appSettings, router, activatedRoute, title, sidenavMenuService) {
        ...
        this.router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationEnd"]) {
            ...
            _this8.parseRoute(_this8.router.routerState.snapshot.root);

            _this8.pageTitle = "";

            _this8.breadcrumbs.forEach(function (breadcrumb) {
              _this8.pageTitle += ' > ' + breadcrumb.name;
            });

            _this8.title.setTitle(_this8.settings.name + _this8.pageTitle);
          }
        });
      }
  ...
  function srcAppThemeComponentsFooterFooterComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".footer {\n  min-height: 100px;\n  padding: 16px 16px 0;\n}\n.footer .subscribe-block {\n  padding: 16px 0 32px 0;\n  text-align: center;\n}\n.footer .subscribe-block h1, .footer .subscribe-block h3 {\n  line-height: 1;\n}\n.footer .subscribe-block h1 {\n  margin-bottom: 6px;\n}\n.footer .subscribe-block .subscribe-search-form {\n  height: 50px;\n  padding: 0 16px;\n}\n.footer .subscribe-block .subscribe-search-form input[type=text] {\n  border: 0;\n  outline: none;\n  padding: 0 25px;\n  font-size: 16px;\n}\n.footer .subscribe-block .subscribe-search-form button {\n  font-size: 16px;\n  padding: 0 24px;\n  border-radius: 0;\n}\n.footer .col-title {\n  font-weight: 600;\n}\n.footer .mat-icon {\n  height: 21px;\n  line-height: 21px;\n}\n.footer .link {\n  text-decoration: none;\n}\n.footer .link:hover {\n  text-decoration: underline;\n}\n.footer .contact-information .mat-icon {\n  margin-right: 10px;\n}\n.footer .copyright {\n  font-size: 13px;\n  font-weight: 300;\n}\n@media (max-width: 575px) {\n  .footer .subscribe-block .subscribe-search-form {\n    height: 40px;\n    margin-top: 16px;\n  }\n  .footer .subscribe-block .subscribe-search-form input[type=text] {\n    padding: 0 8px;\n    font-size: 14px;\n  }\n  .footer .subscribe-block .subscribe-search-form button {\n    font-size: 14px;\n    padding: 0 16px;\n  }\n}\n@media (min-width: 576px) and (max-width: 767px) {\n  .footer .subscribe-block .subscribe-search-form {\n    margin-top: 16px;\n  }\n}\n.sebm-google-map-container {\n  height: 220px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppThemeComponentsMenuMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_product_categories_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var MenuComponent = /*#__PURE__*/function () {
      function MenuComponent(_productCategoriesService) {
        _classCallCheck(this, MenuComponent);

        this._productCategoriesService = _productCategoriesService;
        this.menuCategoriesData = [];
        this.menuCategoriesDetailsData = [];
        this.dataset = [];
      }
      ...
      _createClass(MenuComponent, [{
        ...
        value: function getCategory() {
          ...
          this._productCategoriesService.getCategoryDetails().subscribe(function (result) {
            _this9.menuCategoriesData = result.result.catrgoryWiseItems;
    ...
    MenuComponent.ctorParameters = function () {
      return [{
        type: src_app_services_product_categories_service__WEBPACK_IMPORTED_MODULE_1__["ProductCategoriesService"]
      }];
    };
    ...
    }), __metadata("design:paramtypes", [src_app_services_product_categories_service__WEBPACK_IMPORTED_MODULE_1__["ProductCategoriesService"]])], MenuComponent);
    /***/
  },
      ...
      _createClass(SidenavMenuComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.parentMenu = this.menuItems.filter(function (item) {
            return item.parentId == _this10.menuParentId;
          });
        }
      }, {
        key: "onClick",
          ...
          if (activeMenuItem[0]) {
            (function () {
              ...
              while (menuItem.parentId != 0) {
                ...
                _this11.toggleMenuItem(menuItem.id);
              }
            })();
          }
        }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Hemant\FreeLance\emporium\emporium\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
