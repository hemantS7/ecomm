...
ProductZoomComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./product-zoom.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/products/product/product-zoom/product-zoom.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None,
        styles: [__importDefault(__webpack_require__(/*! ./product-zoom.component.scss */ "./src/app/pages/products/product/product-zoom/product-zoom.component.scss")).default]
    }),
...
/* harmony import */ var ngx_swiper_wrapper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-swiper-wrapper */ "./node_modules/ngx-swiper-wrapper/__ivy_ngcc__/fesm2015/ngx-swiper-wrapper.js");
...
ProductComponent.propDecorators = {
    zoomViewer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['zoomViewer', { static: true },] }],
    directiveRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: [ngx_swiper_wrapper__WEBPACK_IMPORTED_MODULE_4__["SwiperDirective"], { static: true },] }]
};
ProductComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-product',
        template: __importDefault(__webpack_require__(/*! raw-loader!./product.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/products/product/product.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./product.component.scss */ "./src/app/pages/products/product/product.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_app_service__WEBPACK_IMPORTED_MODULE_5__["AppService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
], ProductComponent);
...
/* harmony import */ var src_app_services_product_categories_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/product-categories.service */ "./src/app/services/product-categories.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ProductsComponent = class ProductsComponent {
    constructor(appSettings, activatedRoute, appService, dialog, router, productCategoriesService) {
    ...
    ngOnInit() {
        ...
        // let catgKey = this.activatedRoute.snapshot.params.name;
        // console.log(catgKey);// OUTPUT red
        this.getCategories();
        this.getBrands();
        this.getAllProducts();
        this.sub = this.activatedRoute.params.subscribe(params => {
            this.catgKey = params['name'];
            console.log(this.catgKey);
            let prData = this.categories.filter(x => x.categoryName === this.catgKey);
            if (prData[0] == undefined)
                console.log('undefined');
            else
                this.products = prData[0].products;
        });
    ...
    getCategories() {
        ...
        this.productCategoriesService.getCategoryDetails().subscribe(data => {
            ...
            this.categories = data.result.catrgoryWiseItems;
...
ProductsComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        styles: [__importDefault(__webpack_require__(/*! ./products.component.scss */ "./src/app/pages/products/products.component.scss")).default]
    }),
    __metadata("design:paramtypes", [src_app_app_settings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"],
        ...
        src_app_services_product_categories_service__WEBPACK_IMPORTED_MODULE_6__["ProductCategoriesService"]])
], ProductsComponent);
