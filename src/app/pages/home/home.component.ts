...
export class HomeComponent implements OnInit {
  ...
  constructor(public appService:AppService,private _productCategoriesService: ProductCategoriesService) { }
  ...
  getCategory() {
    this._productCategoriesService.getCategoryDetails().subscribe(result => {
      ...
      console.log('categories',result.result.catrgoryWiseItems)
    });
  }
